...
export const ICONS: Record<string, string[]> = {
  ...
  transmission: ["M7 6h10v2H7zm0 4h10v2H7zm0 4h10v2H7z"],
  ...
  "plus-filled": ["M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"],
  ...
  "filter-filled": ["M10 18h4v-2h-4v2zM3 6v2h18V6H3zm3 7h12v-2H6v2z"],

  // Chevron up filled (Material Design)
  "chevron-up-filled": ["M7 14l5-5 5 5z"],

  // Chevron down filled (Material Design)
  "chevron-down-filled": ["M7 10l5 5 5-5z"],

  // Chevron left filled (Material Design)
  "chevron-left-filled": ["M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"],

  // Chevron right filled (Material Design)
  "chevron-right-filled": ["M8.59 16.59L10 18l6-6-6-6-1.41 1.41L13.17 12z"],
  ...
  "check-filled": ["M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"],
