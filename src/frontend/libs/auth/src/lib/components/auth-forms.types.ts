...
export const DEFAULT_REGISTER_LABELS_DE: RegisterFormLabels = {
  ...
  passwordRequired: 'Passwort ist erforderlich',
  passwordMinLength: 'Passwort muss mindestens 8 Zeichen lang sein',
  passwordWeak: 'Passwort muss Groß-/Kleinbuchstaben, Zahlen und Sonderzeichen enthalten',
...
export const DEFAULT_FORGOT_PASSWORD_LABELS_DE: ForgotPasswordFormLabels = {
  ...
  subtitle: 'Geben Sie Ihre E-Mail-Adresse ein, um einen Link zum Zurücksetzen Ihres Passworts zu erhalten.',
  emailLabel: 'E-Mail-Adresse',
  emailPlaceholder: 'ihre@email.de',
  ...
  successMessage: 'Falls ein Konto mit dieser E-Mail-Adresse existiert, haben wir Ihnen einen Link zum Zurücksetzen des Passworts gesendet.',
  emailRequired: 'E-Mail-Adresse ist erforderlich',
  emailInvalid: 'Bitte geben Sie eine gültige E-Mail-Adresse ein',
};
