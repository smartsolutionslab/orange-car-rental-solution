    ...
    <div class="login-container">
      <div class="login-card">
        ...
        <div class="login-header">
          @if (config().logoUrl) {
            <img [src]="config().logoUrl" [alt]="config().brandName || 'Logo'" class="login-logo" />
          }
        ...
        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="login-form">
          ...
          <div class="form-group">
            <label for="login-email" class="form-label">{{ labels().emailLabel }}</label>
            <input
              id="login-email"
              type="email"
          ...
          <div class="form-group">
            <div class="label-row">
              <label for="login-password" class="form-label">{{ labels().passwordLabel }}</label>
              @if (config().forgotPasswordRoute) {
                <a [routerLink]="config().forgotPasswordRoute" class="forgot-link">
            ...
            <div class="password-wrapper">
              ...
              <button
                ...
                [attr.aria-label]="showPassword() ? labels().hidePassword : labels().showPassword"
              >
                @if (showPassword()) {
        ...
        @if (config().showSocialLogin) {
          ...
          <div class="social-login">
            <button type="button" class="social-button" (click)="onGoogleLogin()">
