...
public static class EnsureDomainExtensions
{
    ...
    /// </summary>
    public static Ensurer<string> AndIsGermanPostalCode(this Ensurer<string> ensurer)
    {
        return ensurer
    ...
    /// </summary>
    public static Ensurer<string> AndIsGermanPhoneNumber(this Ensurer<string> ensurer)
    {
    ...
    /// </summary>
    public static Ensurer<string> AndIsGermanDriversLicenseNumber(this Ensurer<string> ensurer)
    {
        return ensurer
    ...
    /// </summary>
    public static Ensurer<DateOnly> AndIsNotInFuture(this Ensurer<DateOnly> ensurer)
    {
    ...
    /// </summary>
    public static Ensurer<DateOnly> AndIsNotInPast(this Ensurer<DateOnly> ensurer)
    {
    ...
    /// </summary>
    public static Ensurer<DateOnly> AndIsTodayOrFuture(this Ensurer<DateOnly> ensurer)
    {
        if (ensurer.Value < DateOnly.FromDateTime(DateTime.UtcNow.Date))
    ...
    /// </summary>
    public static Ensurer<DateOnly> AndIsAtLeastDaysFromNow(this Ensurer<DateOnly> ensurer, int days)
    {
    ...
    /// </summary>
    public static Ensurer<DateOnly> AndIsAfter(this Ensurer<DateOnly> ensurer, DateOnly compareDate, string? compareName = null)
    {
    ...
    /// </summary>
    public static Ensurer<DateOnly> AndIsBefore(this Ensurer<DateOnly> ensurer, DateOnly compareDate, string? compareName = null)
    {
        if (ensurer.Value >= compareDate)
        {
            var message = compareName != null
    ...
    /// </summary>
    public static Ensurer<DateOnly> AndMeetsMinimumAge(this Ensurer<DateOnly> ensurer, int minimumAge)
    {
    ...
    /// </summary>
    public static Ensurer<string> AndContainsOnlyLettersAndSpaces(this Ensurer<string> ensurer)
    {
    ...
    /// </summary>
    public static Ensurer<string> AndIsIsoCountryCode(this Ensurer<string> ensurer)
    {
        return ensurer
    ...
    /// </summary>
    public static Ensurer<decimal> AndIsValidPrice(this Ensurer<decimal> ensurer)
    {
        if (ensurer.Value < 0)
    ...
    /// </summary>
    public static Ensurer<decimal> AndIsBetween(this Ensurer<decimal> ensurer, decimal min, decimal max)
    {
