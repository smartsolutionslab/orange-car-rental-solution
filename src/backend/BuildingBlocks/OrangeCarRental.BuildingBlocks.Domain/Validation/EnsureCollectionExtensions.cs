...
public static class EnsureCollectionExtensions
{
    ...
    /// </summary>
    public static Ensurer<IEnumerable<T>> AndHasCountBetween<T>(this Ensurer<IEnumerable<T>> ensurer, int minCount,
        int maxCount)
    {
        var count = ensurer.Value?.Count() ?? 0;
    ...
    /// </summary>
    public static Ensurer<IEnumerable<T>> AndAllItemsSatisfy<T>(this Ensurer<IEnumerable<T>> ensurer,
        Func<T, bool> predicate, string? errorMessage = null)
    {
    ...
    /// </summary>
    public static Ensurer<IEnumerable<T>> AndAnyItemSatisfies<T>(this Ensurer<IEnumerable<T>> ensurer,
        Func<T, bool> predicate, string? errorMessage = null)
    {
